...
<div class="col-sm-3"  >
 ...
 <div class="col-sm-9" id="upleft">
  ...
  <c:if test="${fn:length(mlist)==0}">
   <h1 style="color:white;">You are yet to choose your course</h1>
  </c:if>
 <c:if test="${fn:length(mlist)>0}">
 <!--  <h1 style="text-align:center;">Courses you Teach</h1> -->
...
<td class="text-center">${CourseDTO.courseID}</td>
