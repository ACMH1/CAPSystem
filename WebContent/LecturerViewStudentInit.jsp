...
<div class="col-sm-3"  >
 ...
 <h1 style="color:white;">No details found</h1>
    ...
    <c:if test="${fn:length(slist)>0}"> 
    <h1 style="color:white;">View student performance</h1>
...
<c:forEach items="${slist}" var="studentDTO" varStatus="status">
<tr>
<td class="text-center">${status.index}</td>
<td class="text-center">
<a href="StudentPerformance?studentId=${studentDTO.getStudentID()}" id="anc">${studentDTO.getStudentID()}</a>
</td>
